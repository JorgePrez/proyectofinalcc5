...
$query = "Select * from jornada order by codigojornada";
...
while ($row = pg_fetch_row($result)) {
 ...
 echo "\t\t<td><a href=modificarjornada_forma.php?numero=$numero&nombre=$nombre&entrada=$entrada&salida=$salida>Modificar</a></td>\n";
...
<center>
<h2><a href="jornadas.html"><u>Regresar a Menu Jornadas</u></a></h2>
</center>
