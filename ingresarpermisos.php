                    ...
                    <div class="row alto1 ">
                        ...
                        <div class="col-12 ">
                            ...
                            <div class="col-12  d-flex justify-content-center">
                                ...
                                <form id="form1" id=cuadro1 action="enviarpermiso.php" method="post" class="needs-validation" novalidate>
    ...
    echo '<option value="'.$codigoempleado.'">'."$codigoempleado".'</option>';
            ...
            ?>
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-4  d-flex justify-content-center align-items-center">
                                            <input name="fechapermiso" type="date" class="form-control" id="fechapermiso" placeholder="" value="" required>
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-4  d-flex justify-content-center align-items-center">
                                                ...
                                                <select name="tipo" type="text" class="form-control" id="tipo">
                                                    ...
                                                    <option value="A" selected>Ausencia</option>
                                                    <option value="ET">EntradaTarde</option>
                                                    <option value="ST">SalidaTemprano</option>
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-4  d-flex justify-content-center align-items-center">
                                            <input name="motivo" type="text" class="form-control" id="motivo" placeholder="" value="" required>
                                            <div class="invalid-feedback">Complete el campo.</div>   
