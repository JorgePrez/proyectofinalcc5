                    ...
                    <div class="row alto1 ">
                        ...
                        <div class="col-12 ">
                            ...
                            <div class="col-12  d-flex justify-content-center">
                                ...
                                <form id="form2" id=cuadro1 action="modificardep.php" method="post" class="needs-validation" novalidate>
              ...
              ?>
                                    ...
                                    <div class="row" >
                                        ...
                                        <?php
                                                ...
                                                $query2 = "select * from departamento where codigodepartamento=$numero";
                              ...
                              <div class="col-12  d-flex justify-content-center">
                                <h2><br/></h2> </div>
                              <div class="col-12 d-flex justify-content-center align-items-center">
                                <h2><a href="departamentos.html"><u>Regresar a Menu de Departamentos </u></a></h2>
