                    ...
                    <div class="row alto1 ">
                        ...
                        <div class="col-12 ">
                            ...
                            <div class="col-12  d-flex justify-content-center">
                                ...
                                <form id="form1" id=cuadro1 action="enviarempleado.php" method="post" class="needs-validation" novalidate>
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-4  d-flex justify-content-center align-items-center">
                                            <input name="codigoempleado" type="number" class="form-control" id="codigoempleado" placeholder="" value="" required>
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-4  d-flex justify-content-center align-items-center">
                                            <input name="nombrempleado" type="text" class="form-control" id="nombrempleado" placeholder="" value="" required>
                                            <div class="invalid-feedback">Complete el campo.</div>   
